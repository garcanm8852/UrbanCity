	...
	<section class="container mt-5 ">
		<article class="row mt-5 ">
			<div class="col-md-12 mt-5 ">
				...
				<h2>Al eliminar la cuenta se eliminarán todos tus pedidos y el contenido de tu carrito.</h2>
				<h3>Se ha enviado a tu correo un código para eliminar la cuenta.</h3>
			</div>
		</article>
		<article class="row mt-5 ">
			<div class="col-md-12 ">
				<form method="POST" action="ModificarCuenta">
					<div class="form-group ">
						<label for="fValidacion ">Código de eliminación</label> <input id="fValidacion "
							class="form-control " type="text" name="fValidacion">
					</div>
					<button type="submit" class="btn w-100 btn-primary">Eliminar Cuenta</button>
				</form>
