...
<title>Urban City - Registrarse</title>
</head>
...
<body>
	...
	<div class="container-fluid animate__animated animate__fadeIn">
		<div class="row banner Index">
			<div class="col-md-12">
				<h3 class="text-center text-white center">Crear una cuenta en Urban City</h3>
			</div>
		</div>
	</div>
		...
		<article class="row mt-5 ">
			<div class="col-md-12 ">
				<form method="POST">
					...
					<button type="submit" class="btn w-100 btn-primary p-3">Registrarse</button>
				</form>
			</div>
		</article>
	</section>
