				...
				if (request.getParameter("Pagina") != null) {
					for (int k = 0; k < (int) session.getAttribute("NumeroPaginas"); k++) {
						...
						if (Integer.parseInt(request.getParameter("Pagina")) == k) {
							out.print(
									"<li class='page-item active'><a class='page-link page-link pr-5 pl-5' href='Catalogo?Pagina="
											+ k + "'>" + (k + 1) + "</a></li>");
						} else {
							out.print(
									"<li class='page-item'><a class='page-link page-link pr-5 pl-5' href='Catalogo?Pagina="
											+ k + "'>" + (k + 1) + "</a></li>");
						}
