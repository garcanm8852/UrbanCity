				...
				<form method="post">
					...
					<div class="form-froup mt-3">
						<label for="fTelefono">Número de teléfono:</label> <input
							...
							title="El número de telefono debe contener 9 dígitos">
					</div>
					<div class="form-froup mt-3">
					...
					<div class="form-froup mt-3">
						<label for="fNumeroTarjeta">Número de la tarjeta:</label> <input
							...
							name="fNumeroTarjeta" pattern="[0-9]{16}"
							title="El Número de la tarjeta debe contener 16 dígitos" required>
					</div>
					<div class="form-froup mt-3">
						<label for="fMesTarjeta">Mes de vencimiento de la tarjeta:</label>
						<input type="number" max="12" min="1" class="form-control"
							name="fMesTarjeta" pattern="[1-9]{1}}|[10]{1}|[11]{1}}|[12]{1}"
							title="El mes de vencimiento debe estar entre 1 y 12" required>
					</div>
					<div class="form-froup mt-3">
					...
					<div class="form-froup mt-3">
						<label for="fCVVTarjeta">Número secreto de la tarjeta:</label> <input
							...
							class="form-control" name="fCVVTarjeta" pattern="[0-9]{3}"
							title="El Número secreto de la tarjeta debe contener 3 dígitos"
							required>
					</div>
