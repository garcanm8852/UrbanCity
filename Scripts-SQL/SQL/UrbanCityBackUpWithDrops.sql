...
-- Started on 2021-06-10 21:11:52
...
DROP SEQUENCE urbancity.subcategoria_idsubcategoria_seq;
DROP TABLE urbancity.subcategoria;
DROP TABLE urbancity.producto;
DROP TABLE urbancity.pedpro;
DROP SEQUENCE urbancity.pedido_idpedido_seq;
DROP TABLE urbancity.pedido;
DROP SEQUENCE urbancity.guiatalla_idguia_seq;
DROP TABLE urbancity.guiatalla;
DROP SEQUENCE urbancity.cliente_idcliente_seq;
DROP TABLE urbancity.cliente;
DROP SEQUENCE urbancity.categoria_idcategoria_seq;
DROP TABLE urbancity.categoria;
DROP SEQUENCE urbancity.carrito_idcarrito_seq;
DROP TABLE urbancity.carrito;
DROP FUNCTION urbancity."nombreProducto"();
DROP FUNCTION urbancity.datosproductosubcategoria(busquedasubcategoria integer);
DROP FUNCTION urbancity.datosproductoscompletobusqueda(busquedacategoria integer);
DROP FUNCTION urbancity.datosproductoscompleto();
DROP FUNCTION urbancity.datosproductobusqueda(busquedareferencia character varying);
DROP FUNCTION urbancity.datosclientesesion(busquedaemail character varying, busquedacontrasena character varying);
DROP SCHEMA urbancity;
--
...
-- Completed on 2021-06-10 21:11:58
